(function() {
  ...
  var Collapser = function Collapser(btn) {
    ...
    tt.qA = function (selector) {
      var origin = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;
    ...
    tt.getElProperty = {
      height: function height(el) {
        var getAbsoluteH = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    tt.hide = {
      ...
      currentContent: function currentContent(t) {
        var onDisplayedOnly = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  var CollapserHover = function (_Collapser) {
    ...
    function CollapserHover(btn) {
      ...
      var _this = _possibleConstructorReturn(this, (CollapserHover.__proto__ || Object.getPrototypeOf(CollapserHover)).call(this, btn));
  ...
  var CollapserClick = function (_Collapser2) {
    ...
    function CollapserClick(btn) {
      ...
      var _this2 = _possibleConstructorReturn(this, (CollapserClick.__proto__ || Object.getPrototypeOf(CollapserClick)).call(this, btn));
  ...
  var Accordion = function (_Collapser3) {
    ...
    function Accordion(btn) {
      ...
      var _this3 = _possibleConstructorReturn(this, (Accordion.__proto__ || Object.getPrototypeOf(Accordion)).call(this, btn));
  ...
  var AccordionHover = function (_Accordion) {
    ...
    function AccordionHover(btn) {
      ...
      var _this4 = _possibleConstructorReturn(this, (AccordionHover.__proto__ || Object.getPrototypeOf(AccordionHover)).call(this, btn));
  ...
  var AccordionClick = function (_Accordion2) {
    ...
    function AccordionClick(btn) {
      ...
      var _this5 = _possibleConstructorReturn(this, (AccordionClick.__proto__ || Object.getPrototypeOf(AccordionClick)).call(this, btn));
  ...
  var Navigation = function (_Collapser4) {
    ...
    function Navigation(btn, breakPoint) {
      _classCallCheck(this, Navigation);

      var _this6 = _possibleConstructorReturn(this, (Navigation.__proto__ || Object.getPrototypeOf(Navigation)).call(this, btn));
